...
Rustc version 1.8.0-nightly (75271d8f1 2016-02-09) is known to be able to build opai-rs. You can use "[multirust](https://github.com/brson/multirust)" to specify and update nightly versions of rust.
