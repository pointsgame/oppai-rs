...
Rustc version 1.9.0-nightly (241a9d0dd 2016-04-05) is known to be able to build opai-rs. You can use "[multirust](https://github.com/brson/multirust)" to specify and update nightly versions of rust.
