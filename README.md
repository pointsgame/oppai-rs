...
Rustc version rustc 1.8.0-nightly (98a8a7123 2016-02-26) is known to be able to build opai-rs. You can use "[multirust](https://github.com/brson/multirust)" to specify and update nightly versions of rust.
