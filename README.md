...
Rustc version 1.10.0-nightly (2b79e05a0 2016-05-13) is known to be able to build opai-rs. You can use "[multirust](https://github.com/brson/multirust)" to specify and update nightly versions of rust.
